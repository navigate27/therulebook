...
<body>
    ...
    <header class="intro-header" style="background-image: url('img/rules.png')">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="site-heading">
                        <h1>The Rule Book</h1>
                        <hr class="small">
                        <span class="subheading">Rules to follow</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <h3><p>These are the sets of rule to make a girl like you: </p></h3>

                <?php
                  include("ruleconnect.php");

                  $query = $db->query("select * from rules order by rule_num asc");
                  if($query->num_rows!=0){
                  while($rows=$query->fetch_assoc()){
                    $rule = $rows['rule'];
                    $rule_num = $rows['rule_num'];
                    $desc = $rows['desc'];
                    echo "
                    <div class='container'>
                      <div class='row'>
