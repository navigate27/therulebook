...
<head>
    ...
    <title>Ways To Broke With Her</title>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="site-heading">
                        <h1>The Rule Book</h1>
                        <hr class="small">
                        <span class="subheading">Ways to broke up with her</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <h3><p>These are the ways to broke up with her with no hard feeling (more or less): </p></h3>

                <?php
                  include("ruleconnect.php");

                  $query = $db->query("select * from broke");
                  if($query->num_rows!=0){
                    ...
                    <div class='container'>
                      <div class='row'>
                        <div class='[ col-xs-12 col-sm-8 ]'>
                          <ul class='event-list'>
                            <li>
                              <time style='background:#ff5604'>
                                <span class='month'>Way#</span>
                                <span class='day'>$num</span>
                              </time>
                              <div class='info'>
                                <h2 class='title'>$ways</h2>
